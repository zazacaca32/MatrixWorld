 ...
 */
public class CaseGuiLib extends PichGui {

    public CaseGuiLib() {
        ScaledOverlay o = new ImageOverlay(50, 50, 25, 25, new ResourceLocation(Constants.ModID.toLowerCase(), "textures/gui/CaseTexture.png"));
        addOverlay(o);
